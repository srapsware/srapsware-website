...
export default function JourneyTimeline() {
  ...
  const milestone2010Ref = useRef<HTMLLIElement>(null)
  const milestone2015Ref = useRef<HTMLLIElement>(null)
  const milestone2020Ref = useRef<HTMLLIElement>(null)
  const milestone2025Ref = useRef<HTMLLIElement>(null)
