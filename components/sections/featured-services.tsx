        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service) => (
            <Link
              key={service.title}
              href={service.href}
              className="group relative p-8 rounded-2xl border border-border bg-card hover:border-brand/50 hover:bg-brand-soft/30 hover:shadow-xl hover:shadow-brand/5 transition-all duration-300"
            >
