...
function loadMoreProjects(PortfolioJson) {
	var lastId = parseInt($('#projects_items').children(".project").last().attr("projectid"));
	var showproject = $('#projects_items').attr("showproject");

	var data = PortfolioJson;

	if(data[lastId].projectid == data[lastId].total)
	{
		...
		if (data[lastId].projectid % 2 == 0) {
			var categories = '';
			$.each(data[lastId].categories, function(catkey, catvalue) {
				categories += '<span class="portfolio-item-category">' + catvalue + '</span>';
			});
			var projecthtml = '<div class="project item" projectid="' + data[lastId].projectid + '">';
			projecthtml += '<div class="row"><figure class="col-lg-7 offset-lg-5 col-xl-6 offset-xl-5 rounded"> <img src="' + data[lastId].image + '" alt="' + data[lastId].title + '" /></figure>';
			...
			projecthtml += '<h2 class="post-title mb-3">' + data[lastId].title + '</h2></div>';
			projecthtml += '<div class="post-content"><p>' + data[lastId].content + '</p>';
			projecthtml += '<a href="' + data[lastId].url + '" class="more hover link-leaf">See Project</a>';
			projecthtml += '</div></div></div></div></div></div>';
		} else {
			var projecthtml = '<div class="project item" projectid="' + data[lastId].projectid + '">';
			projecthtml += '<div class="row"><figure class="col-lg-8 col-xl-7 offset-xl-1 rounded"> <img src="' + data[lastId].image + '" alt="' + data[lastId].title + '" /></figure>';
			...
			projecthtml += '<h2 class="post-title mb-3">' + data[lastId].title + '</h2></div>';
			projecthtml += '<div class="post-content"><p>' + data[lastId].content + '</p>';
			projecthtml += '<a href="' + data[lastId].url + '" class="more hover link-purple">See Project</a>';
			projecthtml += '</div></div></div></div></div></div>';
		}
