...
But faced with an outcry, Google in May moderated its cull to include only those using the free G Suite for commercial purposes; those using G Suite legacy free edition for non-commercial purposes â€“ individuals and families â€“ were given the option to opt-out of the forced Workspace transition.
...
In fact, it does not appear to affect all that many people. Citing an unidentified source, The New York Times says the number of individuals still using G Suite legacy free edition is "in the thousands." Â®
