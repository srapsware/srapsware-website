...
import { Clock, RefreshCw, Wrench, Server, Zap, Shield, TrendingUp } from 'lucide-react'

export const metadata: Metadata = {
  title: 'Maintenance & Support Services | 24/7 Support | Srapsware',
  description: 'Professional maintenance and support services with 24/7 monitoring, rapid response, bug fixes, performance optimization, and proactive system maintenance.',
  openGraph: {
    title: 'Maintenance & Support Services',
    description: 'Keep your applications running smoothly with professional support',
    type: 'website',
  }
}
  ...
  const processSteps = [
    {
      ...
      description: 'System audit, documentation review, access setup, and SLA definition to understand your infrastructure.',
      duration: '1 week',
      icon: 'Search'
    },
    {
      ...
      description: 'Configure 24/7 monitoring, alerts, logging, and performance tracking across all systems.',
      duration: '1-2 weeks',
      icon: 'Clock'
    },
    {
      ...
      description: 'Regular updates, security patches, dependency upgrades, and preventive maintenance tasks.',
      duration: 'Ongoing',
      icon: 'Tool'
    },
    {
      ...
      description: 'Rapid response to incidents, troubleshooting, root cause analysis, and quick resolution.',
      duration: 'As needed',
      icon: 'Zap'
    },
    {
      ...
      description: 'Continuous performance monitoring, optimization recommendations, and capacity planning.',
      duration: 'Ongoing',
      icon: 'Server'
    },
    {
      ...
      description: 'Monthly reports, quarterly reviews, improvement recommendations, and strategic planning.',
  ...
  return (
    <main>
      ...
      <PageHero
        ...
        description="24/7 monitoring, rapid incident response, proactive maintenance, and expert support. Focus on your business while we keep your applications secure, fast, and reliable."
        ctaPrimary={{
          text: 'Request Support Plan',
          href: '/contact'
        }}
        ctaSecondary={{
