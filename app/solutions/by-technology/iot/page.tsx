...
export default function IoTPage() {
  ...
  return (
    <main>
      <PageHero
        badge="IoT & Connected Devices"
        title="IoT Solutions & Smart Devices"
        description="Build connected IoT ecosystems with real-time monitoring, device management, and edge computing. From smart homes to industrial IoT, we deliver scalable end-to-end solutions."
        ctaPrimary={{
