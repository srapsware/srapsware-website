  ...
  return (
    <main>
      <PageHero
        ...
        description="Build decentralized applications, smart contracts, NFT marketplaces, and DeFi protocols on Ethereum, Solana, Polygon, and other leading blockchain platforms."
        ctaPrimary={{
          text: "Start Your Web3 Project",
          href: "/contact"
        }}
        ctaSecondary={{
