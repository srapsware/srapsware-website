  ...
  return (
    <main>
      <PageHero
        ...
        description="Transform raw data into actionable insights. Custom dashboards, real-time analytics, predictive models, and automated reporting - all in one platform."
        ctaPrimary={{
          text: "Build Your BI Platform",
          href: "/contact"
        }}
        ctaSecondary={{
          text: "See Capabilities",
          href: "#capabilities"
        }}
        breadcrumbItems={[
