  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <section className="border-b border-border bg-muted/30">
        <div className="container mx-auto px-4 py-4">
          <nav className="flex items-center space-x-2 text-sm text-muted-foreground">
            ...
            <span>/</span>
            <span className="text-foreground font-medium">Magento Development</span>
          </nav>
        </div>
      </section>
      ...
      <section className="relative py-20 md:py-32 overflow-hidden">
        ...
        {/* Floating Orbs */}
        <div className="absolute top-20 left-10 w-72 h-72 bg-orange-400/30 rounded-full blur-3xl animate-pulse" />
        <div className="absolute bottom-20 right-10 w-96 h-96 bg-red-400/30 rounded-full blur-3xl animate-pulse" style={{ animationDelay: '1s' }} />
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="grid grid-cols-3 gap-4 mb-8">
                <div className="text-center p-4 rounded-lg bg-white/50 dark:bg-black/20 backdrop-blur-sm border border-white/20">
                  <div className="text-3xl font-bold text-orange-600">$155B</div>
                  <div className="text-sm text-muted-foreground">GMV Annually</div>
                </div>
                <div className="text-center p-4 rounded-lg bg-white/50 dark:bg-black/20 backdrop-blur-sm border border-white/20">
                  <div className="text-3xl font-bold text-red-600">250K+</div>
                  <div className="text-sm text-muted-foreground">Sites Powered</div>
                </div>
                <div className="text-center p-4 rounded-lg bg-white/50 dark:bg-black/20 backdrop-blur-sm border border-white/20">
                  <div className="text-3xl font-bold text-pink-600">100K+</div>
                  <div className="text-sm text-muted-foreground">SKU Support</div>
                </div>
              </div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link 
                  href="/contact"
                  className="inline-flex items-center justify-center px-8 py-4 bg-gradient-to-r from-orange-600 to-red-600 text-white rounded-lg font-semibold hover:shadow-lg hover:scale-105 transition-all duration-200"
                >
                  Start Your Project
                ...
                <Link 
                  href="#enterprise"
                  className="inline-flex items-center justify-center px-8 py-4 border-2 border-orange-600 text-orange-600 dark:text-orange-400 rounded-lg font-semibold hover:bg-orange-50 dark:hover:bg-orange-950/30 transition-all duration-200"
                >
                  Enterprise Features
                </Link>
              </div>
            ...
            <div className="relative">
              <div className="relative rounded-2xl overflow-hidden shadow-2xl border border-white/20 backdrop-blur-sm">
                <Image
                  src="https://picsum.photos/800/600?random=magento"
                  alt="Magento Enterprise E-commerce Platform with Advanced Features"
                  width={800}
                  height={600}
                ...
                <div className="absolute top-6 right-6 bg-white/90 dark:bg-black/90 backdrop-blur-md px-4 py-2 rounded-lg shadow-lg border border-white/20">
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="font-semibold text-sm">Enterprise Ready</span>
                  </div>
                </div>
              </div>
